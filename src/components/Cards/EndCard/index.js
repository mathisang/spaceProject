...
const endObject = [
    {
        "usa": {
            ...
            "message": "Vous avez triomphé ! Les États-Unis sont les premiers à envoyer un humain marcher sur la lune. Vous affirmez votre supériorité face à l’URSS.",
        },
        "urss": {
            "title": "La mission est un échec !",
            "message": "Vous y étiez presque ! L'URSS sont les premiers à envoyer un humain marcher sur la lune.",
        }
    }
]
